...
import { LibraryTab, LIBRARY_TAB_STATUSES, LIBRARY_TAB_LABELS } from "@/src/lib/backend/backlog/domain/models";
import { useAuthStore } from "@/src/lib/frontend/shared/auth/auth.store";
import { useMoods, useGameActions, useGameQuery, useGameFilters } from "@/src/lib/frontend/features";
...
export function useLibrary() {
  ...
  return {
    ...
    handleStatusChange, handleEdit: handleEditSubmit, handleDelete: handleDeleteConfirm,
    handleAdd, showAdd, setShowAdd,
  };
}
