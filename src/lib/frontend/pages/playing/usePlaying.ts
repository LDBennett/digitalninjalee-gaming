...
export function usePlaying() {
  ...
  return {
    ...
    moods, moodFilter, setMoodFilter, searchQuery, setSearchQuery,
    editGame, setEditGame, loading: authLoading, isAuthenticated,
    handleStatusChange, sortBy, setSortBy, platformFilter, setPlatformFilter,
    handleEdit: handleEditSubmit, handleDelete: handleDeleteConfirm,
  };
}
