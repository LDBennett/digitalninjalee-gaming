...
import { WishlistTab, ALL_WISHLIST_STATUSES, WISHLIST_TAB_LABELS } from '@/src/lib/backend/backlog/domain/models';
import { useAuthStore } from '@/src/lib/frontend/shared/auth/auth.store';
import { useMoods, useGameActions, useGameQuery, useGamePriority } from '@/src/lib/frontend/features';
...
export function useWishlist() {
  ...
  return {
    ...
    handleAdd, handleEdit: handleEditSubmit, handleDelete: handleDeleteConfirm,
    handleStatusChange,
