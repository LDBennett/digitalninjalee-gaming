...
import { filterByMood, filterByTitle } from '@/src/lib/backend/backlog/domain/services';

export type SortOption = 'priority-desc' | 'priority-asc' | 'name-asc' | 'name-desc';
  ...
  const filtered = useMemo(() => {
    ...
    return [...result].sort((a, b) => {
      switch (sortBy) {
        ...
        case 'priority-desc': return b.priority_score - a.priority_score;
      }
    });
